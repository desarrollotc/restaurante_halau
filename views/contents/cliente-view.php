      ...
      <!-- <div class="inputContainer">
        ...
        <input type="password" name="campo2" class="form-control" id="exampleInputPassword1" placeholder="*******">
                      ...
                      <input type="hidden" class="form-control" id="numero_cliente_orden" name="numero_cliente_orden"
                        value="<?php print $_SESSION['numero_spm'];?>">
                        <input type="hidden" class="form-control" id="correo_cliente" name="correo_cliente"
                        value="<?php print $_SESSION['correo_spm'];?>">
                        <input type="hidden" class="form-control" id="id_usuario" name="id_usuario"
                        value="<?php print $_SESSION['id_spm'];?>">
      <div class="inputContainer">
